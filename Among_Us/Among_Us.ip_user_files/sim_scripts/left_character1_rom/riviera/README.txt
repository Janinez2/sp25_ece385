...
#
# Generated by export_simulation on Mon May 05 16:03:08 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './left_character1_rom.sh' script.

./left_character1_rom.sh -reset_run
...
./left_character1_rom.sh -noclean_files

For more information on the script, please type './left_character1_rom.sh -help'.
