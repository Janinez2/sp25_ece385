...
#
# Generated by export_simulation on Mon May 05 16:02:15 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './left_character0_rom.sh' script.

./left_character0_rom.sh -reset_run
...
./left_character0_rom.sh -noclean_files

For more information on the script, please type './left_character0_rom.sh -help'.
