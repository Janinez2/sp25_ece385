...
#
# Generated by export_simulation on Mon May 05 16:01:08 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './sprite_2_rom.sh' script.

./sprite_2_rom.sh -reset_run
...
./sprite_2_rom.sh -noclean_files

For more information on the script, please type './sprite_2_rom.sh -help'.
