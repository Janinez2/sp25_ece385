...
#
# Generated by export_simulation on Fri May 09 06:39:44 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './vials_rom.sh' script.

./vials_rom.sh -reset_run
...
./vials_rom.sh -noclean_files

For more information on the script, please type './vials_rom.sh -help'.
