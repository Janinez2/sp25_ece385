...
#
# Generated by export_simulation on Fri May 09 07:32:36 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './task_vials_sprite_rom.sh' script.

./task_vials_sprite_rom.sh -reset_run
...
./task_vials_sprite_rom.sh -noclean_files

For more information on the script, please type './task_vials_sprite_rom.sh -help'.
