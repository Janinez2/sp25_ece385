...
#
# Generated by export_simulation on Mon May 05 15:57:47 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './sprite_0_rom.sh' script.

./sprite_0_rom.sh -reset_run
...
./sprite_0_rom.sh -noclean_files

For more information on the script, please type './sprite_0_rom.sh -help'.
