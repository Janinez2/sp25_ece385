...
#
# Generated by export_simulation on Thu May 08 22:09:53 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './coffee_rom.sh' script.

./coffee_rom.sh -reset_run
...
./coffee_rom.sh -noclean_files

For more information on the script, please type './coffee_rom.sh -help'.
