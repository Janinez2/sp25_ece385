...
#
# Generated by export_simulation on Fri May 09 00:16:30 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './task_num_win_rom.sh' script.

./task_num_win_rom.sh -reset_run
...
./task_num_win_rom.sh -noclean_files

For more information on the script, please type './task_num_win_rom.sh -help'.
