...
#
# Generated by export_simulation on Fri May 09 09:11:01 -0500 2025
#
################################################################################
...
'-reset_run' switch to the './shower_on_rom.sh' script.

./shower_on_rom.sh -reset_run
...
./shower_on_rom.sh -noclean_files

For more information on the script, please type './shower_on_rom.sh -help'.
